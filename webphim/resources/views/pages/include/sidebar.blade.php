                              ...
                              <a href="{{route('movie',$hot_sidebar->slug)}}" title="{{$hot_sidebar->title}}">
                                 <div class="item-link">
                                    ...
                                    @if($image_check == 'https')
                                          <img width="100" src="{{$hot_sidebar->image}}" alt="">
                                    @else
                                          <img class="lazy img-responsive" src="{{asset('uploads/movies/'.$hot_sidebar->image)}}" alt="{{$hot_sidebar->title}}" title="{{$hot_sidebar->title}}">
                                    @endif
